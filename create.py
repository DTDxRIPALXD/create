...
class create_fb:
    ...
    def __init__(self):
        ...
        else : self.ua = 'Mozilla/5.0 (Linux; Android 13; SM-S918B; Build/TP1A.220624.014) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/118.0.4280.141 Mobile Safari/537.36 Firefox-KiToBrowser/118.0'
